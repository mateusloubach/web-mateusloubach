      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h1 className="h1">É ótimo vê-lo novamente. Insira suas credenciais abaixo.</h1>
          </div>
          ...
          <div className="max-w-sm mx-auto">
            ...
            <div className="text-gray-400 text-center mt-6">
              Ainda não é nosso cliente? — <Link href="/signup" className="text-purple-600 hover:text-gray-200 transition duration-150 ease-in-out">Registrar</Link>
            </div>
          </div>

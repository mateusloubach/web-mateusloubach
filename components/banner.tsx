    ...
    <>
      {bannerOpen && (
        <div className="fixed bottom-0 right-0 w-full md:bottom-8 md:right-12 md:w-auto z-50">
          <div className="bg-purple-800 text-slate-50 text-sm p-3 md:rounded shadow-lg flex justify-between">
            <div className="text-black inline-flex">
              <a
                ...
                rel="noreferrer"
              >
                Já é<span className="hidden sm:inline"> nosso Cliente?</span>
              </a>{' '}
